...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'border-b border-border px-4 py-2.5 text-left text-xs font-bold uppercase tracking-wider text-muted-foreground',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td ref={ref} className={cn('px-4 py-3 text-muted-foreground', className)} {...props} />
))
