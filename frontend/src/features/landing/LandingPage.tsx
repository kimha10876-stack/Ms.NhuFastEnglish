...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-svh flex flex-col bg-white">
      ...
      {/* ── Levels ─────────────────────────────────────────────────────────── */}
      <section className="py-10 px-5 border-y bg-surface-muted/60">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {features.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-surface-muted rounded-2xl p-6">
                <div className="w-10 h-10 bg-primary/10 rounded-[8px] flex items-center justify-center mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {latestPosts.map((post) => (
                ...
                >
                  {post.thumbnailUrl && (
                    <div className="aspect-[16/10] rounded-[8px] overflow-hidden mb-4 border bg-gray-50">
                      <img
          ...
          <div className="max-w-md mx-auto bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm">
            ...
            {successMessage ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
 <label htmlFor="form-fullname" className="block text-xs mb-1.5">
                  ...
                  <input
                    ...
                    className={`w-full h-[38px] px-3 rounded-[8px] border bg-white text-sm outline-none transition-all focus:ring-3 focus:ring-amber-500/20 ${
                ...
                <div>
 <label htmlFor="form-phone" className="block text-xs mb-1.5">
                ...
                <div>
 <label htmlFor="form-email" className="block text-xs mb-1.5">
                ...
                <div>
 <label htmlFor="form-message" className="block text-xs mb-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 rounded-[8px] border border-gray-200 bg-white text-sm outline-none transition-all focus:border-amber-500 focus:ring-3 focus:ring-amber-500/20 resize-none"
                  />
                </div>
